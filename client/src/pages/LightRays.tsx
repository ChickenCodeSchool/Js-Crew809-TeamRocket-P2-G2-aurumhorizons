  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (rendererRef.current) {
        rendererRef.current.gl.canvas.parentNode?.removeChild(
          rendererRef.current.gl.canvas,
        );
